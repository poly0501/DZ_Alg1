...
s = input("Введите текст:")  # читаем строку длиной  до 10**4
...
print("Число символов %d\nДлина закодированной строки %d" %(len(code), len(encoded)))  # выведем число символов и длину закодированной строки
